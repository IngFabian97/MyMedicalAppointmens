...
public class UIMenu {
    ...
    public static Patient patiendLogged;
    ...
    private static void authUser(int userType){
        ...
        doctors.add(new Doctor("Karen Villa","karen@mail.com"));
    ...
    static void showPatientMenu(){
        ...
        do{
            ...
            System.out.println("1. Boook an appoinment");
